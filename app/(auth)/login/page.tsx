        ...
        <div className="glass-card border-glow w-full max-w-md rounded-2xl p-10 backdrop-blur-xl">
          ...
          <div className="mt-6 flex flex-col gap-3">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-6 py-3 rounded-xl bg-white text-black font-semibold text-sm hover:bg-slate-100 transition shadow-lg shadow-white/5"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-6 py-3 rounded-xl bg-[#24292e] text-white font-semibold text-sm hover:bg-[#2c3238] transition shadow-lg shadow-black/20 border border-white/10"
            >
